...
class SelectWinnerPage extends StatefulWidget{

  const SelectWinnerPage({Key? key}) : super(key: key);

  @override
  SelectWinnerPageHome createState() => SelectWinnerPageHome();
}

class SelectWinnerPageHome extends State<SelectWinnerPage> with TickerProviderStateMixin{
          ...
          controller: _scrollController,
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Text('Winner selection',style: TextStyle(fontSize: 20),),
                  Text('Prize 1.'),
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Text('A total of ＄10,000 in prize money will be equally distributed among 1 partcipants.'),
                        Text('Winner 1 -＄10,000 '),

                        Stack(
                          children: <Widget>[
                            Image.asset('assets/112726025_p0.png'),
                           ...
                           Container(
                             ...
                             child: Row(
                               ...
                               children: <Widget>[
                                 Text('Logan - Screen Character',style: TextStyle(color: Colors.white),),
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Text('A total of ＄5,000 in prize money will be equally distributed among 2 partcipants.'),
                        Text('Winner 1 -＄2,500 '),

                        Stack(
                          children: <Widget>[
                        Image.asset('assets/111057171_p0.png'),
                        ...
                        Stack(
                          children: <Widget>[
                            Image.asset('assets/113719302_p0.png'),
                  ...
                  const Card(
                    child: Text('Double-check to make sure you have chosen all the winners correctly!',style: TextStyle(color: Colors.red,fontSize: 30),),
                  ),
                  ...
                  SizedBox(
                    ...
                    child: Card(
                      ...
                      color: Colors.blue,
                        ...
                        }, child: Text('Winner selection complete',style: TextStyle(color: Colors.white),)),
